  ...
  return (
    <div className="">
        ...
        <div className="flex gap-2 pt-5 justify-center ">
            ...
            <button onClick={() =>{navigate('/SignUp')}} className="w-[206px] h-[56px] bg-red-600 text-white rounded text-2xl flex items-center justify-center hover:bg-red-700 active:bg-red-800 focus:outline-none ">Get Started 
